...
[![version](https://img.shields.io/github/v/release/1273984347/deep-review-loop)](https://github.com/1273984347/deep-review-loop/releases/latest)
...
- **Tools**: file search (Grep/Read/LS); subagent/task spawning is **optional** — without it, the skill falls back to the degradation mode (see the "no-subagent degradation mode" section in SKILL.md: R1a serial instead of parallel, R1b/R2 self-adversarial review, explicitly marked `degraded (no-subagent)`).
